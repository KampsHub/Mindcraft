...
export const EXERCISES: ExerciseDefinition[] = [
  ...
  },
  {
    ...
    instruction: "Explore the emotion wheel by tapping sectors that resonate with your current state. Start from the broad center categories and drill into more specific feelings at the outer rings. Once you land on the precise emotion, you will be prompted to identify the met or unmet need underneath it. Before closing, choose one small action you can take today to honor the need you identified — even something as simple as asking for it or giving yourself permission to feel it.",
  },
  {
  ...
  },
  {
    ...
    instruction: "A guided dialogue will walk you through a sequence of prompts. First, you will voice the judgments you hold about this person without censoring. Then you will be guided to identify the feelings underneath those judgments, and finally the unmet needs driving those feelings. Each step builds on the previous one — respond to each prompt before moving to the next. Write one concrete request you could make of this person — or one way you will shift your own behavior toward them — based on the need you uncovered.",
    prePopulated: {
      voices: [
  ...
  },
  {
    ...
    instruction: "Start at the top of the branching tree with the 'no' you received (or gave). At each branch level, ask 'What need is this no protecting?' and add the possible needs as branches. Continue drilling down each branch — needs often nest inside other needs. The hierarchy reveals the root need driving the surface-level refusal. Now that you see the root need, craft one alternative proposal that addresses it — a request the other person might say yes to because it honors what they are actually protecting.",
    prePopulated: {
      levels: [
  ...
  },
  {
    ...
    instruction: "You will write across three narrative panels. In the first panel, describe the factual content — what happened, what was said, what each person did. In the second panel, explore the emotional layer — what feelings are present for you and what you imagine for the other person. In the third panel, examine the identity layer — what is at stake for your sense of self. Review all three panels together before planning your approach. Write your opening sentence for the conversation — one that addresses all three layers — and schedule a specific time this week to have it.",
    prePopulated: {
      panels: [
  ...
  },
  {
    ...
    instruction: "In the left column, list the 'faux feelings' — words that sound like emotions but actually contain judgments about others (e.g., 'rejected,' 'ignored,' 'used'). In the right column, translate each into a genuine feeling (what you actually feel in your body) and the observation that triggered it. Notice how the genuine feeling opens space while the faux feeling keeps you stuck. The next time you catch yourself using a faux feeling word, pause and translate it on the spot before you speak or act on it.",
    prePopulated: {
  ...
  },
  {
    ...
    instruction: "Use the spectrum slider to calibrate your risk level. The left end represents total safety (0% risk — saying nothing new), and the right end represents maximum vulnerability (100% risk — full disclosure). Position the slider where your next relational move would land. Then adjust it to the 15% zone — just enough to stretch without snapping. Write what that 15% risk would actually sound like. Commit to delivering that 15% risk statement to the specific person, in a specific context, within the next three days.",
  ...
  },
  {
    ...
    instruction: "Rate each of the seven BRAVING dimensions on the wheel chart, both for yourself and for the other person in this relationship. The seven sectors are: Boundaries, Reliability, Accountability, Vault, Integrity, Non-judgment, and Generosity. Drag each spoke outward to indicate strength in that dimension. The shape of the wheel reveals the trust profile — where it is strong and where it has gaps that need attention. Choose the lowest-scoring dimension and take one repair action this week.",
  ...
  },
  {
    ...
    instruction: "Explore the two overlapping circles. One circle represents 'Heart at Peace' — seeing the other person as a person with needs, fears, and hopes as real as your own. The other represents 'Heart at War' — seeing them as an obstacle, a vehicle, or irrelevant. Place your recent interactions in the appropriate zone, including the overlap where you fluctuated. For items in the 'war' zone, write what it would look like to see that person's humanity. Before your next interaction with someone in the 'war' zone, spend 30 seconds imagining one thing they might be struggling with — then enter the conversation from that awareness.",
    prePopulated: {
  ...
  },
  {
    ...
    instruction: "The two overlapping circles represent Self and a Part. Move the circles to show how much they overlap right now — fully blended (one circle inside the other) means the part has taken over completely; fully separated means you can observe the part with curiosity. Place your current state in the overlap zone. Then identify what the blended part is feeling and what it needs you to know. Notice if naming it creates even a small separation. The next time you feel consumed by a single emotion, pause and say 'A part of me feels [emotion]' instead of 'I am [emotion]' — this language alone creates the unblending.",
    prePopulated: {
  ...
  },
  {
    ...
    instruction: "The two overlapping circles represent true Self-energy and a Self-like part. Explore the qualities in each circle: Self carries all 8 C's (Calm, Curiosity, Clarity, Compassion, Confidence, Courage, Creativity, Connectedness), while a Self-like part carries some but not all. Place your current state in the overlap and identify which C's are present and which are missing. The missing C's point to which part is performing composure rather than embodying it. For one missing C, allow yourself to drop the performance today — if vulnerability is absent, share one honest thing with someone you trust.",
    prePopulated: {
