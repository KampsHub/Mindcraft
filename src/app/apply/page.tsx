        ...
        <div style={{ width: "100%", maxWidth: 560 }}>
          <AnimatePresence mode="wait" custom={direction}>
            ...
            >
              ...
              {screen === 7 && <SelectScreen question="How did you find us?" options={["I'm a former customer", "AI chatbot", "YouTube or online video", "Facebook / Instagram", "Search engine (Google, Bing)", "LinkedIn", "Word of mouth (colleague, friend)", "Reddit", "Other"]} value={form.referral} onSelect={(v) => selectAndAdvance("referral", v)} />}
