    ...
    >
      <div style={{ maxWidth: narrowMax, margin: "0 auto" }}>
        ...
        <FadeIn preset="slide-up" triggerOnMount delay={0.2}>
          ...
          >
            Your performance is under scrutiny?
            <br />
        ...
        <FadeIn preset="slide-up" triggerOnMount delay={0.3}>
          ...
          >
            {["Shock", "Shame", "Anger", "Hypervigilance", "Fear"].map(
              (emotion, i) => (
                <span
                  key={emotion}
                  style={{
        ...
        <FadeIn preset="slide-up" triggerOnMount delay={0.4}>
          ...
          >
            A PIP is not a development opportunity. It is an organizational mechanism that may or may not reflect your actual performance — and it carries real consequences for your livelihood, your reputation, and your sense of self.
          </p>
        </FadeIn>
        ...
        <FadeIn preset="fade" triggerOnMount delay={0.5}>
          ...
          >
            {[
              "Not a resilience program.",
              "Not about performing for a broken system.",
              "Not a guarantee you will pass the PIP.",
              "Not \"turn this into a growth opportunity.\"",
            ].map((line) => (
              <p
                key={line}
                style={{
            ...
            >
              ...
              Thirty days to stay clear-headed during a period that actively works against clarity. Process what is happening to you while continuing to function at work.
            </p>
          </div>
        </FadeIn>
...
function ProofBar() {
  ...
  return (
    <FadeIn preset="fade">
      ...
      >
        <div
          className="jetstream-proof-inner"
          style={{
            maxWidth,
            margin: "0 auto",
            display: "flex",
  ...
  const disruptions = [
    {
      ...
      desc: "The environment that was supposed to support your performance is now the source of threat. Hypervigilance replaces focus. Every interaction with your manager carries subtext.",
    },
    {
      label: "Sense of Competence",
      desc: "A PIP says, formally, that your work is not meeting expectations. Whether that assessment is accurate, political, or somewhere in between — it attaches to your self-concept.",
    },
    {
      label: "Trust in Management",
      desc: "Some PIPs are genuine attempts at course correction. Many are not. The power asymmetry is now explicit. Navigating that while reporting to the person who initiated it is a specific kind of difficult.",
    },
    {
      label: "Professional Identity",
      desc: "In performance cultures, your track record is your identity. A PIP interrupts the narrative. The person who shipped products and led teams is now the person on a plan.",
    },
    {
      label: "Financial Security",
      desc: "A PIP carries the implicit or explicit threat of termination. Financial anxiety activates — not because you have lost income, but because you might.",
    },
    {
      label: "Daily Cognitive Load",
      desc: "You are now running two tracks: doing the work and managing the PIP. Documenting everything. Reading signals. The cognitive overhead is enormous and invisible.",
    },
    {
      label: "Relationships",
      desc: "Who knows? Who is watching? Who is safe? At work, colleagues distance themselves. At home, sustained workplace threat bleeds into your closest relationships.",
    },
  ];
    ...
    <section style={{ ...sectionPadding, background: colors.bgDeep, borderTop: `3px solid ${colors.coral}` }}>
      <div style={{ maxWidth: narrowMax, margin: "0 auto" }}>
        ...
        <FadeIn preset="slide-up">
          ...
          >
            A PIP disrupts seven systems at once
          </h2>
        </FadeIn>
        ...
        <FadeIn preset="slide-up" delay={0.1}>
          ...
          >
            This program addresses all seven so you can think clearly.
          </p>
        </FadeIn>

        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }} className="jetstream-prob-grid">
          {disruptions.map((d, i) => (
        ...
        <FadeIn preset="fade" delay={0.4}>
          <div style={{ marginTop: 36, paddingTop: 24, borderTop: `1px solid ${colors.borderSubtle}` }}>
            ...
            >
              This is not a program that promises you will pass your PIP. It is a practical
              way to stay clear-headed, process what is happening, and make decisions from
              clarity — not reactivity — during a period designed to keep you off-balance.
            </p>
          </div>
        </FadeIn>
        ...
        <FadeIn preset="slide-up" delay={0.45}>
          <div style={{ borderTop: `1px solid ${colors.borderSubtle}`, marginTop: 40, paddingTop: 36 }}>
            ...
            <h3 style={{ fontFamily: display, fontSize: "clamp(22px, 3vw, 30px)", lineHeight: 1.2, color: colors.textPrimary, marginBottom: 28, fontWeight: 700, letterSpacing: "-0.01em" }}>
              A PIP is not a development tool. It is a life event.
            </h3>
            <div className="jetstream-research-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 20 }}>
              {[
                { num: "46%", desc: "of new hires fail within 18 months — 89% for interpersonal reasons, not technical skill. PIPs inherit the same dynamic: the real issue is rarely the one on paper.", source: "Leadership IQ, Hiring for Attitude" },
                { num: "59%", desc: "of employees placed on a PIP do not successfully complete it. Most leave the organization — voluntarily or not — within 90 days.", source: "SHRM, Performance Management" },
                { num: "82%", desc: "of managers report seeing warning signs before formal action — but the employee is usually the last to understand what is really being evaluated.", source: "Leadership IQ, Hiring for Attitude" },
              ].map((stat, i) => (
      ...
      <div style={{ maxWidth: narrowMax, margin: "0 auto" }}>
        ...
        <FadeIn preset="fade" delay={0.25}>
          <div style={{ marginBottom: 56, borderBottom: `1px solid ${colors.borderSubtle}`, paddingBottom: 48 }}>
            ...
            >
              {[
                { week: "Week 1", title: "Land", desc: "Separate the PIP from your identity. Get emotionally clear. Map the disruptions and build a regulation toolkit for every manager meeting." },
                { week: "Week 2", title: "Steady", desc: "Perform under pressure without losing yourself. Name your patterns. Build optionality so decisions come from choice, not survival." },
                { week: "Week 3", title: "Build", desc: "Rebuild your sense of competence. Separate useful feedback from unhelpful narrative. Set boundaries. Make smart decisions while still delivering." },
                { week: "Week 4", title: "Orient", desc: "Know your next move. Reinstatement, negotiated exit, or your own decision to leave \u2014 make it from clarity, not reactivity." },
              ].map((w, i) => (
            ...
            <div style={{ display: "flex", gap: 8, marginBottom: 0 }}>
              {steps.map((step) => (
                ...
                >
                  ...
                  <span
                    className="jetstream-step-label"
                    style={{
                      fontFamily: body,
                      fontSize: 10,
                      fontWeight: 600,
...
function TestimonialCarousel() {
  const testimonials = [
    { quote: "The three-column exercise — valid, political, cannot tell — changed everything. I stopped spiraling and started thinking.", who: "Senior product manager" },
    { quote: "I was performing compliance theater and burning out. The program helped me see the saboteur patterns running the show.", who: "Engineering lead" },
    { quote: "The optionality audit gave me leverage I did not know I had. I negotiated an exit on my terms.", who: "Former director of marketing" },
    { quote: "Having something structured to do every morning during the worst period of my career — that alone was worth it.", who: "Senior designer" },
  ];
...
function Outcomes() {
  const items = [
    { label: "A clear-eyed assessment", desc: "Not optimistic, not pessimistic. A grounded read of what is happening — what is valid feedback, what is political, and what you cannot tell." },
    { label: "Language for what is happening", desc: "That does not collapse into either self-blame or victimhood. You can describe your situation accurately." },
    { label: "A grounded sense of competence", desc: "Not contingent on one manager's evaluation. Evidence-based, tested against cognitive distortions, rooted in your actual track record." },
    { label: "Pattern awareness", desc: "Your saboteurs, your stress responses, your communication defaults under pressure — named, tracked, and interruptible." },
    { label: "Your complete journal", desc: "Every entry, exercise, framework analysis, and daily summary — downloadable as PDF or JSON." },
    { label: "A decision made from clarity", desc: "Whether you stay, negotiate, or leave — the person making that move knows what they value and what they are dealing with." },
  ];
  ...
  return (
    <section style={{ ...sectionPadding, background: "#D9D7D4" }}>
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 24px" }}>
        ...
        <div
          className="jetstream-outcomes-grid"
          style={{
            display: "grid",
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 24px" }}>
        ...
        {/* Tier cards */}
        <div
          className="jetstream-price-grid"
          style={{
            display: "grid",
        ...
        >
          ...
          <FadeIn preset="slide-up" delay={0.1} style={{ display: "flex" }}>
            ...
            >
              ...
              <p style={{ fontFamily: display, fontSize: 36, fontWeight: 700, color: colors.textPrimary, marginBottom: 4, letterSpacing: "-0.02em" }}>$75</p>
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  backgroundColor: colors.plumLight, color: colors.bgDeep,
                  transition: "all 0.25s ease", border: "none",
        ...
        <FadeIn preset="fade" delay={0.4}>
          ...
          >
            ...
            <div
              className="jetstream-features-grid"
              style={{
                display: "grid",
                gridTemplateColumns: "1fr 1fr",
                gap: "8px 32px",
  ...
  return (
    <section style={{ ...sectionPaddingSmall, background: "#D9D7D4" }}>
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 24px" }}>
        ...
        <FadeIn preset="slide-up">
          <div
            className="jetstream-privacy-grid"
...
function FAQ() {
  ...
  const items: { q: string; a: string; topic: string }[] = [
    ...
    {
      topic: "The program",
      q: "Will this help me pass my PIP?",
      a: "This program does not guarantee any outcome with your employer. It builds the internal infrastructure — self-awareness, communication clarity, strategic thinking, and emotional regulation — for navigating the full arc however it ends.",
    },
    {
      topic: "The program",
      q: "Where do the exercises come from?",
      a: "The library includes frameworks from Positive Intelligence, NVC, Gottman, cognitive distortion work, polyvagal theory, boundary architecture, and others.",
    },
    {
      topic: "The program",
      q: "Is this therapy?",
    ...
    },
    {
      ...
      a: "30 days of structured, personalized coaching built around your PIP. 6 goals built from your situation, 180+ exercises from a 250+ tool library, journal analysis, framework-based pattern work, and access until your goals are done. One payment.",
    },
    {
      topic: "Pricing",
    ...
    },
    {
      ...
      a: "Most personality tests tell you your type and stop there. The IEQ9 Integrative Enneagram shows you why you shut down, over-perform, or spiral under pressure — and what to do about it. It is the tool professional coaches and therapists actually use. The full package includes the program, the assessment, and a 1-hour live debrief with a certified coach. Your results shape every exercise, so the program hits where it matters most.",
    },
    {
      topic: "Pricing",
    ...
    <section style={{ ...sectionPadding, background: colors.bgDeep }}>
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 24px" }}>
        ...
        <FadeIn preset="fade" delay={0.1}>
          <div
            className="jetstream-faq-layout"
            style={{
              display: "grid",
  ...
  return (
    <style>{`
      @media (max-width: 960px) {
        .jetstream-price-grid { grid-template-columns: 1fr 1fr !important; }
      }
      @media (max-width: 520px) {
        .jetstream-price-grid { grid-template-columns: 1fr !important; }
      }
      @media (max-width: 768px) {
        .jetstream-pers-grid { grid-template-columns: 1fr !important; }
        .jetstream-arc-grid { grid-template-columns: 1fr 1fr !important; }
        .jetstream-price-grid { grid-template-columns: 1fr !important; }
        .jetstream-features-grid { grid-template-columns: 1fr !important; }
        .jetstream-proof-inner { flex-direction: column !important; gap: 16px !important; }
        .jetstream-prob-grid { grid-template-columns: 1fr !important; }
        .jetstream-prob-row { grid-template-columns: 1fr !important; gap: 4px !important; }
        .jetstream-not-grid { grid-template-columns: 1fr !important; }
        .jetstream-addon-grid { grid-template-columns: 1fr !important; text-align: center !important; }
        .jetstream-honest-grid { grid-template-columns: 1fr !important; }
        .jetstream-privacy-grid { grid-template-columns: 1fr 1fr 1fr !important; }
        .jetstream-research-grid { grid-template-columns: 1fr !important; }
        .jetstream-testimonial-grid { grid-template-columns: 1fr !important; }
        .jetstream-outcomes-grid { grid-template-columns: 1fr !important; }
        .jetstream-faq-layout { grid-template-columns: 1fr !important; gap: 24px !important; }
        .jetstream-faq-nav { flex-direction: row !important; flex-wrap: wrap !important; position: static !important; gap: 8px !important; }
      }
