...
function FAQ() {
  ...
  const items: { q: string; a: string; topic: string }[] = [
    ...
    },
    {
      ...
      a: "30 days of structured, personalized coaching built around your PIP. 6 goals built from your situation, 180+ exercises from a 350+ tool library, journal analysis, framework-based pattern work, and access until your goals are done. One payment.",
    },
    {
      topic: "Pricing",
