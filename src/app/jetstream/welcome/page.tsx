...
export default function JetstreamWelcomePage() {
  return (
    <Suspense fallback={
      ...
      <div style={{ position: "relative", maxWidth: 480, margin: "0 auto", padding: "80px 24px 64px" }}>
        ...
        {verified === true && (
          <>
            ...
            >
              Clarity under pressure starts here.
            </motion.h1>
            ...
            >
              You chose to deal with this instead of just enduring it. That takes clarity most people don&rsquo;t have right now. Create your account and start whenever you&rsquo;re ready.
            </motion.p>
            ...
            {!success ? (
              <motion.div {...fade(0.7)}>
                ...
                <motion.div {...fade(0.9)}>
                  ...
                  {[
                    "Answer 6 short questions so the program fits your situation.",
