        ...
        <FadeIn preset="fade" triggerOnMount delay={0.5}>
          ...
          >
            ...
            >
              ...
              Thirty days to process what happened, rebuild the narrative
              on your terms, and walk into whatever comes next — clear,
              grounded, and yours.
            </p>
          </div>
        </FadeIn>
...
function AfterProgram() {
  const paths = [
    ...
    {
      num: 2,
      title: "Continue with daily coaching — $35/month",
...
function FAQ() {
  ...
  const items: { q: string; a: string; topic: string }[] = [
    ...
    },
    {
      ...
      a: "Layoffs hit your finances. We did not want cost to be the reason someone cannot access this program. The standard price is $75. If that is too much right now, pick anything from $35-74 — no proof, no questions. If you have room, the $76-125 tier helps fund access for people in financial hardship. Everyone gets the exact same program.",
    },
    {
      topic: "Pricing",
    ...
    },
    {
      ...
      a: "Three options: start another program (like New Role), continue with daily coaching for $35/month with no fixed arc, or end and download all your data. Your history, values work, and assessment data carry forward if you continue.",
    },
    {
      topic: "Data & privacy",
...
function SampleDay() {
  const moments = [
    { time: "Morning", label: "Open your journal", desc: "A prompt based on where you are in the program and what you wrote yesterday. 2-3 minutes of honest writing." },
    { time: "Morning", label: "Coaching plan exercise", desc: "One exercise matched to what surfaced in your journal. Sourced, cited, 5 minutes." },
    { time: "Anytime", label: "Framework analysis", desc: "A named framework from a published author, applied to a pattern identified in your recent entries." },
    { time: "Anytime", label: "Overflow exercises", desc: "Up to 5 optional exercises across cognitive, emotional, somatic, relational, and integrative modalities. Do one, do all, skip entirely." },
    { time: "Evening", label: "Day close + reflection", desc: "What your coaching intelligence surfaced. Multi-day patterns. Rate exercises 1-5. Download your daily summary." },
  ];
      ...
      <FadeIn preset="fade">
        ...
        >
          ...
          <div>
            ...
            >
              Having moved to the US from Germany, it has been hard to watch the
              American corporate system at play. It can be brutal, cunning,
              dehumanizing, self-righteous. I know what it does to you when you
              lose a job you loved. It took years to change the internal story.
            </p>
            <p
              style={{
                fontFamily: body,
