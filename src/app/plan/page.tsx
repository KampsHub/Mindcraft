  ...
  if (loading) {
    return (
      <div style={{ ...containerStyle, textAlign: "center", paddingTop: 120 }}>
        <p style={{ color: "#888" }}>Loading your coaching plan...</p>
      </div>
    );
  }
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center" }}>
          <button
            ...
            style={{
              ...
              color: "#fff", backgroundColor: generating ? "#999" : "#2563eb",
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={{
        ...
        border: "1px solid #e2e8f0", borderRadius: 12, marginBottom: 32,
      }}>
      ...
      {/* Goals */}
      <h2 style={{ fontSize: 20, fontWeight: 600, marginBottom: 16 }}>Goals</h2>
      <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 36 }}>
        {plan.goals.map((g, i) => (
          <div key={i} style={{
            padding: 20, border: "1px solid #e2e8f0", borderRadius: 10,
          }}>
            <h3 style={{ fontSize: 15, fontWeight: 600, margin: "0 0 6px 0" }}>
              {g.goal}
            </h3>
      ...
      {/* Focus Areas */}
      <h2 style={{ fontSize: 20, fontWeight: 600, marginBottom: 16 }}>Focus Areas</h2>
      <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 36 }}>
        {plan.focus_areas.map((f, i) => (
          <div key={i} style={{
            ...
            <p style={{ fontSize: 14, color: "#333", margin: "0 0 8px 0", lineHeight: 1.5 }}>
              {f.description}
            </p>
      ...
      {/* Weekly Themes */}
      <h2 style={{ fontSize: 20, fontWeight: 600, marginBottom: 16 }}>12-Week Journey</h2>
          ...
          <div key={i} style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
              <span style={{
                ...
                backgroundColor: "#eff6ff", padding: "2px 10px",
                borderRadius: 12,
              }}>
                Weeks {w.weeks}
              </span>
            ...
            <p style={{ fontSize: 14, color: "#333", margin: "0 0 10px 0", lineHeight: 1.5 }}>
              {w.description}
            </p>
