      ...
      <div style={{ position: "relative", maxWidth: 640, margin: "0 auto", padding: "80px 24px 64px" }}>
        ...
        <div style={sectionStyle}>
          ...
          <p style={textStyle}>
            ...
            receive are generated by artificial intelligence (currently Claude by Anthropic). This
            content is designed to be helpful and grounded in real coaching frameworks, but:
          </p>
          <ul style={listStyle}>
